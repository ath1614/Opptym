    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-lg font-semibold text-gray-900">Available Article Platforms</h3>
        ...
        {loading ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-gray-600">No article platforms available</p>
            <p className="text-sm text-gray-500">Contact admin to add article platforms</p>
          </div>
        ) : (
