  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Social Media Platforms</h1>
          <p className="text-gray-600 mt-2">Submit and manage your social media content across various platforms</p>
        </div>
