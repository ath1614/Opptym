            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                >
                  ...
                  {availableFilters.classifications.map((classification: any) => {
                    // Handle both string and object formats
                    const value = typeof classification === 'string' ? classification : classification.name;
                    const display = typeof classification === 'string' ? classification : classification.name;
